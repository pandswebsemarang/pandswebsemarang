(function () {
	...
	$document
		...
		.on( 'madxartwork/popup/hide', resetInitializedNamespace )
	...
	jQuery( window ).on( 'madxartwork/frontend/init', function() {
		...
		window.madxartworkFrontend.hooks.addAction( 'frontend/element_ready/jet-booking-calendar.default', function( $scope ) {
