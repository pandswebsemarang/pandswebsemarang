...
export default class ActiveItems {
	...
	constructor($activeItems, props = {}) {
		...
		this.$madxartworkWidget = this.$activeItemsContainer.closest('.hide-widget');
	...
	buildItems() {
		this.$madxartworkWidget.removeClass('hide-widget');
		...
		if (isEmpty(activeItems)) {
			...
			this.$madxartworkWidget.addClass('hide-widget');
