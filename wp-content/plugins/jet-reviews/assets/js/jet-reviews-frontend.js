...
// madxartwork Public Scripts
( function( $, madxartworkFrontend, publicConfig ) {
	'use strict';

	let JetReviewsmadxartwork = {
		init: function() {

			var widgets = {
				'jet-reviews.default' : JetReviewsmadxartwork.widgetJetReviewsSimple,
				'jet-reviews-advanced.default' : JetReviewsmadxartwork.widgetJetReviewsAdvanced,
			};
	...
	$( window ).on( 'madxartwork/frontend/init', JetReviewsmadxartwork.init );
...
}( jQuery, window.madxartworkFrontend, window.jetReviewPublicConfig ) );
