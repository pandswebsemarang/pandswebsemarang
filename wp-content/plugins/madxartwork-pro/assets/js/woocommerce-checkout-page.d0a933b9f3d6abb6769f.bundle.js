...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["woocommerce-checkout-page"],{
...
class Checkout extends _base.default {
  getDefaultSettings() {
    ...
    return {
      selectors: { ...defaultSettings.selectors,
        container: '.madxartwork-widget-woocommerce-checkout-page',
  ...
  bindEvents() {
    ...
    madxartworkFrontend.elements.$body.on('updated_checkout', () => {
  ...
  applyPurchaseButtonHoverAnimation() {
    ...
    if (purchaseButtonHoverAnimation) {
      ...
      jQuery('#place_order').addClass('madxartwork-animation-' + purchaseButtonHoverAnimation);
    }
  }
    ...
    jQuery.ajax({
      ...
      success(code) {
        ...
        if (code) {
          ...
          madxartworkFrontend.elements.$body.trigger('applied_coupon_in_checkout', [data.coupon_code]);
          madxartworkFrontend.elements.$body.trigger('update_checkout', {
  ...
  loginUser() {
    ...
    const data = {
      action: 'madxartwork_woocommerce_checkout_login_user',
    ...
    jQuery.ajax({
      ...
      success(code) {
        ...
        if (code.logged_in) {
          ...
          madxartworkFrontend.elements.$body.trigger('checkout_error', [code.message]);
        }
      }
...
//# sourceMappingURL=woocommerce-checkout-page.d0a933b9f3d6abb6769f.bundle.js.map