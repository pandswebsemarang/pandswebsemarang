...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["woocommerce-my-account"],{
...
class MyAccountHandler extends _base.default {
  ...
  toggleEndpointClasses() {
    ...
    if ('dashboard' === this.currentPage && this.elements.$contentWrapper.find('.madxartwork').length) {
  ...
  applyButtonsHoverAnimation() {
    ...
    if (elementSettings.forms_buttons_hover_animation) {
      this.$element.find('.woocommerce button.button,  #add_payment_method #payment #place_order').addClass('madxartwork-animation-' + elementSettings.forms_buttons_hover_animation);
    }

    if (elementSettings.tables_button_hover_animation) {
      this.$element.find('.order-again .button, td .button, .woocommerce-pagination .button').addClass('madxartwork-animation-' + elementSettings.tables_button_hover_animation);
    }
  }
  ...
  onElementChange(propertyName) {
    ...
    if ('customize_dashboard_select' === propertyName) {
      madxartworkPro.modules.woocommerce.onTemplateIdChange('customize_dashboard_select');
    }
  }
  ...
  bindEvents() {
    ...
    madxartworkFrontend.elements.$body.on('keyup change', '.register #reg_password', () => {
      this.equalizeElementHeights();
    });
  }
...
//# sourceMappingURL=woocommerce-my-account.2650f0840cbfb2116ca7.bundle.js.map