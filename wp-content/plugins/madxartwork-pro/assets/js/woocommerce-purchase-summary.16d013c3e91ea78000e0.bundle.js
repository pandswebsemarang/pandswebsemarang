...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["woocommerce-purchase-summary"],{
...
class PurchaseSummaryHandler extends _base.default {
  getDefaultSettings() {
    return {
      selectors: {
        container: '.madxartwork-widget-woocommerce-purchase-summary',
        address: 'address',
  ...
  applyButtonsHoverAnimation() {
    ...
    if (elementSettings.order_details_button_hover_animation) {
      this.$element.find('.order-again .button, td .button').addClass('madxartwork-animation-' + elementSettings.order_details_button_hover_animation);
    }
  }
...
//# sourceMappingURL=woocommerce-purchase-summary.16d013c3e91ea78000e0.bundle.js.map