...
class TOCHandler extends madxartworkModules.frontend.handlers.Base {
  ...
  handleNoHeadingsFound() {
    const noHeadingsText = __('No headings were found on this page.', 'madxartwork-pro');

    return this.elements.$tocBody.html(noHeadingsText);
  }

  collapseBodyListener() {
    const activeBreakpoints = madxartworkFrontend.breakpoints.getActiveBreakpointsList({
      withDesktop: true
    });
...
//# sourceMappingURL=table-of-contents.72a102c751f8095122c9.bundle.js.map