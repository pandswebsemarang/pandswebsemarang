...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["load-more"],{
...
class LoopLoadMore extends _loadMore.default {
  getDefaultSettings() {
    ...
    defaultSettings.selectors.loadMoreButton = '.e-loop__load-more .madxartwork-button';
  ...
  runElementHandlers(postsElements) {
    [...postsElements].flatMap(el => [...el.querySelectorAll('.madxartwork-element')]).forEach(el => madxartworkFrontend.elementsHandler.runReadyTrigger(el));
  }
...
class LoadMore extends madxartworkModules.frontend.handlers.Base {
  getDefaultSettings() {
    return {
      selectors: {
        postsContainer: '.madxartwork-posts-container',
        postWrapperTag: 'article',
        loadMoreButton: '.madxartwork-button',
  ...
  onInit() {
    ...
    this.postId = madxartworkFrontendConfig.post.id; // Set the current page and last page for handling the load more post and when no more posts to show.
  ...
  handleInfiniteScroll() {
    ...
    this.observer = madxartworkModules.utils.Scroll.scrollObserver({
      callback: event => {
