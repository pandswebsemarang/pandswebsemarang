...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["slides"],{
...
class SlidesHandler extends madxartworkModules.frontend.handlers.SwiperBase {
  getDefaultSettings() {
    return {
      selectors: {
        slider: '.madxartwork-slides-wrapper',
        slide: '.swiper-slide',
  ...
  async initSlider() {
    ...
    // since it depends on an additional class besides 'madxartwork-ken-burns--active'
