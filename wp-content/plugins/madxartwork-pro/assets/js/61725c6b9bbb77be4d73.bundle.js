...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["modules_query-control_assets_js_editor_template-query-control_js"],{
...
class TemplateQueryControl extends _queryControl.default {
  ...
  createTemplate() {
    if (!this.confirmSaveBeforeTemplateCreateDialog) {
      this.confirmSaveBeforeTemplateCreateDialog = madxartworkCommon.dialogsManager.createWidget('confirm', {
        id: 'e-confirm-save-before-template-create',
        headerMessage: __('Save Changes', 'madxartwork-pro'),
        message: __('Would you like to save the changes you\'ve made?', 'madxartwork-pro'),
        position: {
          my: 'center center',
          at: 'center center'
        },
        strings: {
          confirm: __('Save', 'madxartwork-pro'),
          cancel: __('Discard', 'madxartwork-pro')
        },
        onConfirm: async () => {
  ...
  async switchDocument(id) {
    ...
    const document = madxartwork.documents.getCurrent();
  ...
  getSelect2Placeholder() {
    return {
      id: '',
      text: __('Start typing its name', 'madxartwork-pro')
    };
  }
...
//# sourceMappingURL=61725c6b9bbb77be4d73.bundle.js.map