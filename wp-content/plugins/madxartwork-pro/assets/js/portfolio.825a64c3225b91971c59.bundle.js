...
"use strict";
(self["webpackChunkmadxartwork_pro"] = self["webpackChunkmadxartwork_pro"] || []).push([["portfolio"],{
...
var _default = _posts.default.extend({
  isActive(settings) {
    return settings.$element.find('.madxartwork-portfolio').length;
  },
  ...
  getDefaultSettings() {
    ...
    jQuery.extend(settings.classes, {
      ...
      item: 'madxartwork-portfolio-item',
      ghostItem: 'madxartwork-portfolio-ghost-item'
    });
    return settings;
  },
  ...
  getDefaultElements() {
    ...
    elements.$filterButtons = this.$element.find('.madxartwork-portfolio__filter');
    return elements;
  },
  ...
  filterItems(term) {
    var $posts = this.elements.$posts,
        ...
        termSelector = '.madxartwork-filter-' + term;
  ...
  arrangeGrid() {
    ...
    $activeShownItems.each(function () {
      ...
      if (madxartworkFrontend.config.is_rtl) {
...
//# sourceMappingURL=portfolio.825a64c3225b91971c59.bundle.js.map