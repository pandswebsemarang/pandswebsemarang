(function( $ ) {
	...
	var JetSearch = {
		...
		widgetAjaxSearch: function( $scope ) {
			...
			var settings = {
					...
					isRtl:              ( window.madxartworkFrontend && window.madxartworkFrontend.config.is_rtl ) ? window.madxartworkFrontend.config.is_rtl : $( 'body' ).hasClass( 'rtl' )
				};
			...
			self.inputChangeHandler = function( event ) {
				...
				if ( value ) {
					...
					timer = setTimeout( function() {
						data.value = value;
						data.deviceMode = window.madxartworkFrontend && window.madxartworkFrontend.getCurrentDeviceMode() ? window.madxartworkFrontend.getCurrentDeviceMode() : false;
	...
	$( window ).on( 'madxartwork/frontend/init', JetSearch.initmadxartwork );
