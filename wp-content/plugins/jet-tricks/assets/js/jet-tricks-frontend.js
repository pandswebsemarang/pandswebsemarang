( function( $, madxartwork ) {
	...
	var JetTricks = {
		...
		init: function() {
			madxartwork.hooks.addAction( 'frontend/element_ready/section', JetTricks.madxartworkSection );
			madxartwork.hooks.addAction( 'frontend/element_ready/container', JetTricks.madxartworkSection );
			madxartwork.hooks.addAction( 'frontend/element_ready/column', JetTricks.madxartworkColumn );
			madxartwork.hooks.addAction( 'frontend/element_ready/widget', JetTricks.madxartworkWidget );
		...
		madxartworkColumn: function( $scope ) {
			var $target  = $scope,
				$parentSection = $scope.closest( '.madxartwork-section' ),
				isLegacyModeActive = !!$target.find( '> .madxartwork-column-wrap' ).length,
				$window  = $( window ),
				...
				stickyInstanceOptions = {
					topSpacing: 50,
					bottomSpacing: 50,
					containerSelector: isLegacyModeActive ? '.madxartwork-row' : '.madxartwork-container',
					innerWrapperSelector: isLegacyModeActive ? '.madxartwork-column-wrap' : '.madxartwork-widget-wrap',
				},
				$observerTarget = $target.find('.madxartwork-element');
		...
		widgetUnfold: function( $scope ) {
			var $target                = $scope.find( '.jet-unfold' ),
				...
				settings               = $.extend( {}, $target.data( 'settings' ), JetTricks.getmadxartworkElementSettings( $scope ) ),
	...
	$( window ).on( 'madxartwork/frontend/init', JetTricks.init );
