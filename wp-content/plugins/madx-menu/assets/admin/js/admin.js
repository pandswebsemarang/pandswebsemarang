...
( function( $, settings ) {
	...
	var jetMenuAdmin = {
		...
		openEditor: function() {
			...
			loader = $popup.find( '#madxartwork-loading' );
		...
		closePopup: function( event ) {
			...
			$( this )
				...
				.siblings( '#madxartwork-loading' ).fadeIn( 0 );
		},
		...
		closeEditor: function( event ) {
			...
			if ( $content.madxartwork.saver && 'function' === typeof $content.madxartwork.saver.isEditorChanged ) {
				saver = $content.madxartwork.saver;
			} else if ( 'function' === typeof $content.madxartwork.isEditorChanged ) {
				saver = $content.madxartwork;
			}
