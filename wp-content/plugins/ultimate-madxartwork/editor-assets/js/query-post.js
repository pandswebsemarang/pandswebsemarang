( function( $ ) {
	...
	jQuery( window ).on( 'madxartwork:init', function() {
		var ControlQueryPostSearch = madxartwork.modules.controls.BaseData.extend( {
			...
			addControlSpinner: function() {
				...
				this.$el.find( '.madxartwork-control-title' ).after( '<span class="madxartwork-control-spinner">&nbsp;<i class="fa fa-spinner fa-spin"></i>&nbsp;</span>' );
			},
			onReady: function() {
				var self = this;
		...
		madxartwork.addControlView( 'uael-query-posts', ControlQueryPostSearch );
	} );
