( function( $ ) {
	...
	var WidgetUAELWooAddToCart = function( $scope, $ ) {
		...
		$('body').off('added_to_cart.uael_cart' ).on( 'added_to_cart.uael_cart', function(e, fragments, cart_hash, btn){
			...
			if ( btn.closest('.madxartwork-widget-uael-woo-add-to-cart').length > 0 ) {
	...
	.on( 'click', '.uael-woocommerce-pagination a.page-numbers', function( e ) {
		...
		$scope = $( this ).closest( '.madxartwork-widget-uael-woo-products' );
	...
	$( window ).on( 'madxartwork/frontend/init', function () {
		madxartworkFrontend.hooks.addAction('frontend/element_ready/uael-woo-products.grid-default', WidgetUAELWooProducts);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/uael-woo-products.grid-franko', WidgetUAELWooProducts);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/uael-woo-add-to-cart.default', WidgetUAELWooAddToCart);
		madxartworkFrontend.hooks.addAction('frontend/element_ready/uael-woo-categories.default', WidgetUAELWooCategories);
	});
