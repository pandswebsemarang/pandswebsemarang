( function( $ ) {
	...
	$( document ).on( 'click', '.uael-trigger', function() {
		...
		var popup_id = $( this ).closest( '.madxartwork-element' ).data( 'id' );
	...
	$( document ).ready( function( e ) {
		...
		if( current_url.indexOf( '&action=madxartwork' ) <= 0 ) {
			$( '.uael-modal-parent-wrapper' ).each( function() {
	...
	var WidgetUAELModalPopupHandler = function( $scope, $ ) {
		...
		if ( $scope.hasClass('madxartwork-hidden-desktop') ) {
        	$( '.uamodal-' + scope_id ).addClass( 'uael-modal-hide-desktop' );
		}

		if ( $scope.hasClass('madxartwork-hidden-tablet') ) {
        	$( '.uamodal-' + scope_id ).addClass( 'uael-modal-hide-tablet' );
		}

		if ( $scope.hasClass('madxartwork-hidden-phone') ) {
	...
	$( window ).on( 'madxartwork/frontend/init', function () {
		...
		madxartworkFrontend.hooks.addAction( 'frontend/element_ready/uael-modal-popup.default', WidgetUAELModalPopupHandler );
