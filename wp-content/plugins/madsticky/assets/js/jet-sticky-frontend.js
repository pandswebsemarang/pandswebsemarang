( function( $, madxartwork ) {
	...
	var JetSticky = {
		...
		init: function() {
			madxartwork.hooks.addAction( 'frontend/element_ready/column', JetSticky.madxartworkColumn );

			madxartworkFrontend.hooks.addAction( 'frontend/element_ready/section', JetSticky.setStickySection );
		...
		madxartworkColumn: function( $scope ) {
			var $target  = $scope,
				...
				stickyInstanceOptions = {
					topSpacing: 50,
					bottomSpacing: 50,
					containerSelector: '.madxartwork-section',
					innerWrapperSelector: '.madxartwork-widget-wrap'
				};
	...
	$( window ).on( 'madxartwork/frontend/init', JetSticky.init );
