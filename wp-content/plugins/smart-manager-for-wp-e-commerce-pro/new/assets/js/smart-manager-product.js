jQuery(function($) {
	...
	$(document).ready(function() {
		...
		$(document).on('sm_jqgrid_titlebar_load',function(e){
			...
			if( jQuery("#sm_top_bar_left").find('#sm_products_show_variations_span').length == 0 ) {
			...
			$('#sm_products_show_variations').off('change').on('change',function() {
		...
		$(document).on('sm_on_cell_click',function(e,rowid, celname, value, iRow, iCol){
			...
			$(".chosen-container-multi").css({'width': '250px !important', 'margin-bottom': '7px'});
