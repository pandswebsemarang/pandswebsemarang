var JetQueryDialog = (function () {
	...
	function JetQueryDialog( options ) {
		...
		this.createControls = function() {
			...
			this.$applyButton.className   = 'jet-query-action-done madxartwork-button madxartwork-button-default madxartwork-button-success';
		...
		this.newRepeater = function( control, children, value, parent ) {
			...
			var Repeater = function( control, children, value, parent ) {
				...
				this.newRepeaterRow = function( name, children, value ) {
					...
					removeButton.className = 'jet-query-repeater-row__remove madxartwork-button madxartwork-button-default';
				...
				$button.className = 'jet-query-repeater-add madxartwork-button madxartwork-button-default';
				$button.type = 'button';
		...
		this.errorMessage = function( notices ) {
			...
			this.$cancelButton           = document.createElement( 'button' );
			this.$cancelButton.className = 'jet-query-errors-cancel madxartwork-button madxartwork-button-default';
			this.$cancelButton.type      = 'button';
			this.$cancelButton.innerHTML = '&times; Cancel';
...
// madxartwork integration
jQuery( window ).on( 'madxartwork:init', function() {

	dialogView = window.madxartwork.modules.controls.BaseData.extend( {
	...
	window.madxartwork.addControlView( 'jet_query_dialog', dialogView );
