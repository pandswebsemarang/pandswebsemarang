		...
		init: function() {
			...
			var QueryControlItemView = madxartwork.modules.controls.Select2.extend({
				...
				ui: function() {
					...
					var ui = madxartwork.modules.controls.Select2.prototype.ui.apply( this, arguments );
				...
				events: function() {
					...
					var events = madxartwork.modules.controls.Select2.prototype.events.apply( this, arguments );
				...
				renderCreateButton: function() {
					...
					this.$el.find( '.madxartwork-control-field' ).after( $createHandler );
