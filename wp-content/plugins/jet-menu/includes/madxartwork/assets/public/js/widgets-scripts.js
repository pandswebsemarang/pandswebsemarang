( function( $, madxartwork ) {
	...
	var JetMenuWidget = {
		...
		widgetMegaMenu: function( $scope ) {
			let $megaMenu   = $scope.find( '.jet-mega-menu--location-madxartwork' ),
		...
		widgetCustomMenu: function( $scope ) {
			...
			function setSubMenuPosition(){
				...
				var subMenu  = $( '.jet-custom-nav__sub', $target ),
					...
					isMobile = 'mobile' === madxartwork.getCurrentDeviceMode();
	...
	$( window ).on( 'madxartwork/frontend/init', JetMenuWidget.init );
