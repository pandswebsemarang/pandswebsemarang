( function( $ ) {
	...
	class JetMegaMenuClass {
		...
		maybeTemplateLoad( templateId, templateContent, $templateContainer ) {
			...
			let getMegaContentUrl = 'default' === templateContent ? window.jetMenuPublicSettings.getBlocksTemplateApiUrl : window.jetMenuPublicSettings.getmadxartworkTemplateApiUrl;
	...
	window.jetMenu = {
		...
		init: function() {
			...
			$( window ).on( 'jet-menu/ajax/frontend-init', ( event, payload ) => {
				jetMenu.maybemadxartworkFrontendInit( payload.$container );
			} );
			...
			Vue.component( 'mobile-menu-item', {
				...
				computed: {
					...
					getTemplateUrl: function() {
						return 'default' === this.itemDataObject.megaContentType ? window.jetMenuPublicSettings.getBlocksTemplateApiUrl : window.jetMenuPublicSettings.getmadxartworkTemplateApiUrl;
					},
		...
		maybemadxartworkFrontendInit: function( $templateContainer ) {
