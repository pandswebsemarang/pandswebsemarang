( function( $ ) {
	...
	JetMenuPlugin.prototype = {
		...
		maybeTemplateLoad: function( templateId, $templateContainer ) {
			...
			$.ajax( {
				type: 'GET',
				url: window.jetMenuPublicSettings.getmadxartworkTemplateApiUrl,
				dataType: 'json',
				data: {
					'id': templateId,
				...
				success: function( responce, textStatus, jqXHR ) {
					...
					jetMenu.madxartworkContentRender( $templateContainer, templateContent );
				}
			} );
		},
...
( function( $ ) {
	...
	window.jetMenu = {
		...
		mobileVueComponents: function() {
			...
			Vue.component( 'mobile-menu-item', {
				...
				methods: {
					...
					getmadxartworkTemplate: function() {
				...
				methods: {
					...
					showTemplateContent: function() {
						...
						this.$nextTick( function() {
							...
							jetMenu.madxartworkContentRender( $templateContainer );
						} );
					},
					...
					initTemplatesContent: function() {
						...
						this.$nextTick( function() {
							...
							if ( vueInstance.headerContent ) {
								...
								jetMenu.madxartworkContentRender( $headerContainer );
							}

							if ( vueInstance.beforeContent ) {
								let $beforeContainer = $( vueInstance.$refs['before-template-content'] );

								jetMenu.madxartworkContentRender( $beforeContainer );
							}

							if ( vueInstance.afterContent ) {
								let $afterContainer = $( vueInstance.$refs['after-template-content'] );

								jetMenu.madxartworkContentRender( $afterContainer );
							}
						} );
					},
		...
		madxartworkContentRender: function( $templateContainer, templateContent ) {
			...
			Promise.all( jetMenu.addedAssetsPromises ).then( function( value ) {
				...
				jetMenu.madxartworkFrontendInit( $templateContainer );
		...
		madxartworkFrontendInit: function( $templateContainer ) {
			...
			$templateContainer.find( 'div[data-element_type]' ).each( function() {
				...
				try {
					if ( 'widget' === elementType ) {
						...
						if ( window.madxartworkFrontend && window.madxartworkFrontend.hooks ) {
