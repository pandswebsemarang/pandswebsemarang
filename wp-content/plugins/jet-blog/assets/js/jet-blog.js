;( function( $, madxartwork, settings ) {
	...
	var JetBlog = {
		...
		handleSmartListingPager: function() {
			...
			var $this        = $( this ),
				...
				id           = $wrapper.closest('.madxartwork-widget-jet-blog-smart-listing').data('id'),
	...
	$( window ).on( 'madxartwork/frontend/init', JetBlog.init );
...
}( jQuery, window.madxartworkFrontend, window.JetBlogSettings ) );
