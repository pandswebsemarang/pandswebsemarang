( function( $ ) {
	...
	var JetBlocksEditor = {
		...
		init: function() {
			...
			madxartwork.channels.editor.on( 'section:activated', JetBlocksEditor.onAuthSectionActivated );
			madxartwork.channels.editor.on( 'section:activated', JetBlocksEditor.onSearchSectionActivated );
			madxartwork.channels.editor.on( 'section:activated', JetBlocksEditor.onCartSectionActivated );

			window.madxartwork.on( 'preview:loaded', function() {
				madxartwork.$preview[0].contentWindow.JetBlocksEditor = JetBlocksEditor;
		...
		onPreviewLoaded: function() {
			...
			madxartworkFrontend.hooks.addAction( 'frontend/element_ready/jet-hamburger-panel.default', function( $scope ){
	...
	$( window ).on( 'madxartwork:init', JetBlocksEditor.init );
